...
public class SessionBrowse extends StandardLookup<Session> {
    ...
    @Subscribe("sessionsCalender")
    public void onSessionsCalenderCalenderEventClick(Calendar.CalendarEventClickEvent<LocalDateTime> event){
    ...
    @Subscribe("sessionsCalender")
    public void onSessionsCalenderCalenderEventMove(Calendar.CalendarEventMoveEvent<LocalDateTime> event){
